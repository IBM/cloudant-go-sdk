...
- Built-in [Changes feed follower](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Changes_Follower.md)
- Built-in [Pagination](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Pagination.md) (beta)
...
1. As [environment variables](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Authentication.md#authentication-with-environment-variables)
2. The [programmatic approach](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Authentication.md#programmatic-authentication)
3. With an [external credentials file](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Authentication.md#authentication-with-external-configuration)
...
Consult the [authentication document](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Authentication.md)
...
[More tutorial examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Examples.md) for creating a database
...
The [update document](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs/Examples.md#3-update-your-previously-created-document) section
...
- [Cloudant Go SDK feature docs](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.5/docs)
