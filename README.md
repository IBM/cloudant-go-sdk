...
# IBM Cloudant Go SDK Version 0.7.3
...
- A
  ...
  server.
- Go version 1.21 or 1.22.


## Installation

The current version of this SDK: 0.7.3
...
```terminal
go get -u github.com/IBM/cloudant-go-sdk/cloudantv1@v0.7.3
```
...
[core-container-auth]: https://github.com/IBM/go-sdk-core/blob/main/Authentication.md#container-authentication
[core-vpc-auth]: https://github.com/IBM/go-sdk-core/blob/main/Authentication.md#vpc-instance-authentication
[core-iam-auth]: https://github.com/IBM/go-sdk-core/blob/main/Authentication.md#identity-and-access-management-iam-authentication
[core-bearer-auth]: https://github.com/IBM/go-sdk-core/blob/main/Authentication.md#bearer-token-authentication
[core-basic-auth]: https://github.com/IBM/go-sdk-core/blob/main/Authentication.md#basic-authentication
[core-no-auth]: https://github.com/IBM/go-sdk-core/blob/main/Authentication.md#no-auth-authentication
...
For a complete list of code examples, see the [examples directory](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.3/examples#examples-for-go).
...
write code to use the SDK's [POST `_changes` API](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.3/examples#postchanges) instead of the follower.
...
may be achieved by using the SDK's [POST `_changes` API](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.3/examples#postchanges).
...
[embedmd]:# (test/examples/src/changes_follower/initialize.go /package main/ $)
```go
package main
...
[embedmd]:# (test/examples/src/changes_follower/start.go /package main/ $)
```go
package main
...
[embedmd]:# (test/examples/src/changes_follower/start_one_off.go /package main/ $)
```go
package main
...
[embedmd]:# (test/examples/src/changes_follower/start_and_process.go /package main/ $)
```go
package main
...
[embedmd]:# (test/examples/src/changes_follower/start_one_off_and_process.go /package main/ $)
```go
package main
...
[embedmd]:# (test/examples/src/changes_follower/stop.go /package main/ $)
```go
package main
...
[KNOWN_ISSUES file](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.3/KNOWN_ISSUES.md) to verify that your issue hasn't been reported yet.
...
For more information, see [CONTRIBUTING](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.3/CONTRIBUTING.md).

## License

This SDK is released under the Apache 2.0 license. To read the full text of the license, see [LICENSE](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.3/LICENSE).
