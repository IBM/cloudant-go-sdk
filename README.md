...
# IBM Cloudant Go SDK Version 0.10.14
...
- Built-in [Changes feed follower](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Changes_Follower.md)
- Built-in [Pagination](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Pagination.md)
...
The current version of this SDK: 0.10.14
...
```terminal
go get -u github.com/IBM/cloudant-go-sdk/cloudantv1@v0.10.14
```
...
1. As [environment variables](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Authentication.md#authentication-with-environment-variables)
2. The [programmatic approach](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Authentication.md#programmatic-authentication)
3. With an [external credentials file](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Authentication.md#authentication-with-external-configuration)
...
Consult the [authentication document](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Authentication.md)
...
[More tutorial examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Examples.md) for creating a database
and document create, read, update and delete operations.

For a complete list of code examples, see the [examples directory](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/examples#examples-for-go).
...
The [update document](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs/Examples.md#3-update-your-previously-created-document) section
...
- [Cloudant Go SDK feature docs](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/docs)
...
[KNOWN_ISSUES file](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/KNOWN_ISSUES.md) to verify that your issue hasn't been reported yet.
...
For more information, see [CONTRIBUTING](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/CONTRIBUTING.md).

## License

This SDK is released under the Apache 2.0 license. To read the full text of the license, see [LICENSE](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.14/LICENSE).
