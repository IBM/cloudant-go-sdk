...
# IBM Cloudant Go SDK Version 0.7.6
...
The current version of this SDK: 0.7.6
...
```terminal
go get -u github.com/IBM/cloudant-go-sdk/cloudantv1@v0.7.6
```
...
For a complete list of code examples, see the [examples directory](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.6/examples#examples-for-go).
...
write code to use the SDK's [POST `_changes` API](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.6/examples#postchanges) instead of the follower.
...
may be achieved by using the SDK's [POST `_changes` API](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.6/examples#postchanges).
...
[KNOWN_ISSUES file](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.6/KNOWN_ISSUES.md) to verify that your issue hasn't been reported yet.
...
For more information, see [CONTRIBUTING](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.6/CONTRIBUTING.md).

## License

This SDK is released under the Apache 2.0 license. To read the full text of the license, see [LICENSE](https://github.com/IBM/cloudant-go-sdk/tree/v0.7.6/LICENSE).
