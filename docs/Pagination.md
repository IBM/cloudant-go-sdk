...
* Query all documents [global](https://cloud.ibm.com/apidocs/cloudant?code=go#postalldocs)
  ...
  * [Global all documents examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/all_docs_pagination.go)
  * [Partitioned all documents examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/partition_all_docs_pagination.go)
* Query all [design documents](https://cloud.ibm.com/apidocs/cloudant?code=go#postdesigndocs)
  * [Design documents examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/design_docs_pagination.go)
* Query with selector syntax [global](https://cloud.ibm.com/apidocs/cloudant?code=go#postfind)
  ...
  * [Global find selector query examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/find_pagination.go)
  * [Partitioned find selector query examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/partition_find_pagination.go)
* Query a search index [global](https://cloud.ibm.com/apidocs/cloudant?code=go#postsearch)
  ...
  * [Global search examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/search_pagination.go)
  * [Partitioned search examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/partition_search_pagination.go)
* Query a MapReduce view [global](https://cloud.ibm.com/apidocs/cloudant?code=go#postview)
  ...
  * [Global view examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/view_pagination.go)
  * [Partitioned view examples](https://github.com/IBM/cloudant-go-sdk/tree/v0.10.17/test/examples/src/pagination/partition_view_pagination.go)
